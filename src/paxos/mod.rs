...
#[derive(Clone, Debug)]
pub struct Vote<P: Paxos> {
    value: Arc<P::Value>,
    ord: BallotOrdinal<P::Pid>,
}

#[derive(Clone)]
pub struct PaxosInstance<P: Paxos> {
    id: InstanceId,
    my_pid: P::Pid,
...
#[derive(Clone, Debug)]
pub struct PaxosMessage<P: Paxos> {
    src: P::Pid,
...
#[derive(Clone, Debug)]
pub enum PaxosMessageDetail<P: Paxos> {
    Prepare,
